 ...
 * 解説通りに実装したソースコード
 *
 * https://atcoder.jp/contests/abc231/editorial/3060 のslopeメソッドの実装<br/>
 * https://atcoder.jp/contests/abc231/submissions/27806041 にも参考
 */
public class ProblemH {
	...
	public static void main(String[] args) {
		try (Scanner scanner = new Scanner(System.in)) {
			...
			System.out.println(Math.min(answerBase,
					graph.slope(s, t).stream().mapToLong(r -> answerBase + r.cost - INF * r.cap).min().getAsLong()));
		}
	}
